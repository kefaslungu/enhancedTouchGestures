...
def onInstall():
	...
	if sys.getwindowsversion().build < 9600 and gui.messageBox(_("You are using an older version of Windows. This add-on requires Windows 8.1 or later. Are you sure you wish to install this add-on anyway?"),
